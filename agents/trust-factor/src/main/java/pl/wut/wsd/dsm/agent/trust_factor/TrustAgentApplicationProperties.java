...
public class TrustAgentApplicationProperties implements AgentStartupInfo {
    ...
    static TrustAgentApplicationProperties parse(final String[] commandLineArgs) throws Exception {
        ...
        return TrustAgentApplicationProperties.builder()

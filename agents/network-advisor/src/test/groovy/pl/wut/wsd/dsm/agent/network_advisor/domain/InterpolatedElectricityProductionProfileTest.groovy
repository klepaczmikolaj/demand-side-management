...
class InterpolatedElectricityProductionProfileTest extends Specification {
    ...
    def 'Should provide nice result profile'() {
        given:
        final InterpolatedElectricityProductionProfile profile = new InterpolatedElectricityProductionProfile(productionPoints)

        when:
        profile.getProductionInWatts(fixedTime.plusHours(1))
